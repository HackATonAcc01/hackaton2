    ...
    1: {
        ...
        'checkpoints': [
            ...
            },
            {
                ...
                'map_iframe': (
                    'https://yandex.ru/map-widget/v1/'
                    '?ll=43.619400%2C52.991700'
                    '&z=14'
                    '&pt=43.619400%2C52.991700%2Cpm2rdl'
                ),
            ...
            },
            {
                ...
                'map_iframe': (
                    'https://yandex.ru/map-widget/v1/'
                    '?ll=48.402900%2C54.314500'
                    '&z=16'
                    '&pt=48.402900%2C54.314500%2Cpm2rdl'
                ),
            ...
            },
            {
                ...
                'map_iframe': (
                    'https://yandex.ru/map-widget/v1/'
                    '?ll=49.121400%2C55.789200'
                    '&z=16'
                    '&pt=49.121400%2C55.789200%2Cpm2rdl'
                ),
            ...
            },
            {
                ...
                'map_iframe': (
                    'https://yandex.ru/map-widget/v1/'
                    '?ll=52.054500%2C55.756500'
                    '&z=15'
                    '&pt=52.054500%2C55.756500%2Cpm2rdl'
                ),
    ...
    2: {
        ...
        'checkpoints': [
            ...
            },
            {
                ...
                'map_iframe': (
                    'https://yandex.ru/map-widget/v1/'
                    '?ll=49.319100%2C53.507900'
                    '&z=15'
                    '&pt=49.319100%2C53.507900%2Cpm2rdl'
                ),
            ...
            },
            {
                ...
                'map_iframe': (
                    'https://yandex.ru/map-widget/v1/'
                    '?ll=48.252700%2C54.269800'
                    '&z=15'
                    '&pt=48.252700%2C54.269800%2Cpm2rdl'
                ),
            ...
            {
                'id': 4,
                'name': 'Музей М. Т. Калашникова, Ижевск',
                'description': 'Музей, посвящённый легендарному конструктору стрелкового '
                               'оружия и истории Ижевского оружейного завода.',
                'media': 'фото',
                'fact': 'Автомат Калашникова (АК-47) — самое распространённое '
                        'стрелковое оружие в мире.',
                'lat': 56.844600,
                'lon': 53.204800,
                ...
                'quiz_question': 'В каком году был создан автомат Калашникова?',
                'quiz_answers': ['1945', '1947', '1950', '1942'],
                'correct_answer': 1
            },
            {
                'id': 5,
                ...
                'map_iframe': (
                    'https://yandex.ru/map-widget/v1/'
                    '?ll=52.412000%2C55.726000'
                    '&z=15'
                    '&pt=52.412000%2C55.726000%2Cpm2rdl'
                ),
